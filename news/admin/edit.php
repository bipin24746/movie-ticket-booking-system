        ...
        if (in_array($file_ext, $allowed_extensions)) {
          if ($file_size < 5242880) { // Max file size: 5MB (you can adjust this value)
            ...
            if (move_uploaded_file($file_tmp, $destination)) {
              ...
              $sql = "UPDATE movie SET name='$name', genre = '$genre', industry = '$industry', language = '$language', duration = '$duration', reldate = '$reldate', director = '$director', actor = '$actor', price='$price', fdate='$fdate', sdate = '$sdate', fshow = '$fshow', image='$image' WHERE id=$id";
              $result = $conn->query($sql);
