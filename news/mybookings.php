...
// Fetch the logged-in user's email address from the session variable
$email = $_SESSION['email'];

// Fetch all the bookings for the logged-in user using the email address
$sql = "SELECT booking.*, movie.name AS movie_name FROM booking JOIN movie ON booking.movie_id = movie.id WHERE booking.email = '$email'";
